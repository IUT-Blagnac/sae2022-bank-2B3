...
|7b|Entrer le montant et choisisez le type d'opération puis sélectionner le bouton "effectuer un crédit"|le crésit est bien effectué (retour à la page "Gestion des opérations")|nok
|=======================
****
