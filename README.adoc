...
|         | CdC V1      |  link:https://github.com/IUT-Blagnac/sae2022-bank-beluga/tree/main/Cahier%20des%20charges[CDC v1]|
|| Suivi Projet ||       
| 22/04   | CdC V2/V3 final|  link:https://github.com/IUT-Blagnac/sae2022-bank-beluga/tree/main/Cahier%20des%20charges[CDC v2, v3]|Le nom du repository n'est pas conforme !!! la prochanine fois on ne corrige pas ...
2/2 présentation OK
