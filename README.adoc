...
link:http://iutweb.fr/V1.html[voir le CDC v1 en meilleur format]

link:http://iutweb.fr/V2V3.html[voir le CDC v2 et v3 en meilleur format]
...
| 03/04   | Gantt V1    |link:https://github.com/IUT-Blagnac/sae2022-bank-beluga/blob/main/GANTT/GANTT%20V1.pdf[GANTT V1]                                   |présent
|         | CdC V1      |  link:https://github.com/IUT-Blagnac/sae2022-bank-beluga/tree/main/Cahier%20des%20charges[CDC v1]                                 |Présent
|         | Suivi Projet |                                   |       
| 22/04   | CdC V2/V3 final|  link:https://github.com/IUT-Blagnac/sae2022-bank-beluga/tree/main/Cahier%20des%20charges[CDC v2, v3]                                   |complet
